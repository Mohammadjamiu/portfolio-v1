...
import { motion } from "framer-motion";
import { BookOpen, GraduationCap, LightbulbIcon, School } from "lucide-react";

const journeyItems = [
  {
    year: "2025",
    title: "Founded Monoed.Africa",
    description:
      "Developed an AI-powered educational platform empowering African students with innovative tools.  ",
  ...
  {
    year: "2024",
    title: "First Class Muslim Foundation Program",
    description:
      "Selected for the prestigious M-First Series program, an initiative focused on nurturing high-achieving Muslim graduates through comprehensive mentorship, professional networking, and career guidance. ",
    icon: <School className="w-6 h-6" />,
    color: "text-emerald-600",
    bg: "bg-emerald-100",
  },
  {
    year: "2024",
    title: "Telecommunications Engineering Graduate",
    description:
      "Graduated with First Class Honours from Bayero University, Kano. Emerged as the Best Graduating Telecommunication Engineering Student.",
    icon: <GraduationCap className="w-6 h-6" />,
    color: "text-blue-600",
    bg: "bg-blue-100",
  },
  {
    year: "2021",
    title: "Founded Tooabstractive.com",
    description:
      "Created an educational platform while in Level 300, focusing on simplifying complex engineering concepts for students worldwide. The platform now attracts over 10,000 monthly readers.",
    icon: <LightbulbIcon className="w-6 h-6" />,
    color: "text-purple-600",
            ...
            >
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span
                      className={`text-sm font-medium ${item.color} bg-gray-100 px-2 py-1 rounded`}
                    >
                      {item.year}
                    </span>
                    <h3 className="text-lg font-semibold text-gray-900">
